...
- ✅ **상점/인벤토리 시스템 MVP**
  - ShopItem, UserInventory 모델 및 마이그레이션
  - ShopController: 아이템 목록, 구매 (Gems 차감)
  - InventoryController: 인벤토리 조회, Seer Stone 사용 (정답 코드 반환)
  - 상점 페이지: 아이템 목록, 구매 모달, confetti 효과
  - 인벤토리 페이지: 보유 아이템 표시
...
- ✅ **"Swifty 만들기" 코스 (10개 레슨)**
  ...
  - Chapter 2: Swifty의 판단력 (if-else, switch)
...
- ✅ **E2E 테스트 (Playwright)**
  ...
  - 랜딩/로그인 페이지 테스트 (17개 통과)
  - 코스/레슨/상점/인벤토리 테스트 준비 (백엔드 연동 후 활성화)
  - npm test, test:ui, test:headed, test:report 스크립트
...
- [x] Gems 표시 UI *(사이드바, 상점 페이지)*
- [x] 상점 페이지 *(swiftboot-web/src/app/(dashboard)/shop/page.tsx)*
...
- [x] E2E 테스트 (Playwright)
  ...
  - [x] 랜딩/로그인 페이지 테스트 (17개 통과)
  - [x] 코스/레슨/상점/인벤토리 테스트 준비 (백엔드 연동 후 활성화)
- [ ] 접근성 검수 (axe-core)
- [ ] 브라우저 호환성 테스트
...
| 2.6 | 2025-12-30 | **E2E 테스트 구현**: Playwright 설치/설정, 랜딩/로그인 테스트 17개 통과, 코스/레슨/상점 테스트 준비 (백엔드 연동 후 활성화), Phase 2B 진행률 90% |
